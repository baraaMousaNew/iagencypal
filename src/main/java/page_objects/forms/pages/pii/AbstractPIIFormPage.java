...
public class AbstractPIIFormPage implements FormsActors {
    ...
    protected final By viewFormSubmittedDateTimeLabel = By.xpath("//div[contains(@class,'signature_writing')]//div[contains(@class,'date')][1]//div[1]");
    protected final By viewFormSubmittedDate = By.xpath("//div[contains(@class,'signature_writing')]//div[contains(@class,'date')][1]//div[2]");
    protected final By viewFormSubmittedTime = By.xpath("//div[contains(@class,'signature_writing')]//div[contains(@class,'date')][1]//div[3]");
    protected final By viewFormSubmittedIPLabel = By.xpath("//div[contains(@class,'signature_writing')]//div[contains(@class,'date')][2]//div[1]");
    protected final By viewFormSubmittedIPValue = By.xpath("//div[contains(@class,'signature_writing')]//div[contains(@class,'date')][2]//div[2]");
    protected final By viewFormSendDateLabel = By.xpath("//div[contains(@class,'ipal_pi_form_header')]//div[@class='caption']");
    protected final By viewFormSendDateValue = By.xpath("//div[contains(@class,'ipal_pi_form_header')]//div[@class='caption clr-gray']");
    ...
    protected AbstractPIIFormPage(WebActions actions, AssertionsContext assertion){
        this.actions = new ActionsHelper<>().getActions();
        this.assertion = assertion;
    }

    public AbstractPIIFormPage(){
